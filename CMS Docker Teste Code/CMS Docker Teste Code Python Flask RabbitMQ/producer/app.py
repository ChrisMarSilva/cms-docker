...
def enviar():
	...
	try:
		...
		if msg:
			...
			#connection = pika.BlockingConnection(pika.ConnectionParameters("amqp://rabbitmq?connection_attempts=5&retry_delay=5"))
			#connection = pika.BlockingConnection(pika.ConnectionParameters("amqp://guest:guest@rabbit/"))
			#connection = pika.BlockingConnection(pika.ConnectionParameters("amqp://guest:guest@localhost/rabbit"))
			#connection = pika.BlockingConnection(pika.ConnectionParameters("amqp://guest:guest@localhost"))
			#connection = pika.BlockingConnection(pika.ConnectionParameters("amqp://guest:guest@localhost:5672/rabbitmq"))
			#connection = pika.BlockingConnection(pika.URLParameters("amqp://guest:guest@localhost:5672/rabbitmq"))
