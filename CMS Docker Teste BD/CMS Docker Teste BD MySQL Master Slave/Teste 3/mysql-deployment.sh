...
master-slave() {
	...
	echo
	echo The master is running on $IP_ADDR:4406,  
	echo The slave is running on $IP_ADDR:5506.
	echo
}
...
master-master() {
	...
	sleep 2
        ...
        echo in case of any errors, check if your containers up and running, then rerun this script.
        echo
        echo The masteir1 is running on $IP_ADDR:4406,
        echo The master2 is running on $IP_ADDR:5506.
        echo
